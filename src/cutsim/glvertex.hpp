...
struct GLVertex {
    ...
    /// rotate vertex around A and C axis, (C first, then A)
    ...
    /// rotate vertex around B and C axis, (C first, then B)
    GLVertex rotateBC(const GLfloat b, const GLfloat c) {
        GLfloat M[3][3];
        GLfloat zC = cos(c);
        GLfloat zS = sin(c);
        GLfloat yC = cos(b);
        GLfloat yS = sin(b);
        M[0][0] =  zC * yC;  M[0][1] = -zS * yS;  M[0][2] =  yS;
        M[1][0] =  zS;       M[1][1] =  zC;       M[1][2] = 0.0;
        M[2][0] = -zC * yS;  M[2][1] =  zS * yS;  M[2][2] =  yC;
        // matrix multiply
        GLVertex result;
        result.x = x * M[0][0] + y * M[0][1] + z * M[0][2];
        result.y = x * M[1][0] + y * M[1][1];
        result.z = x * M[2][0] + y * M[2][1] + z * M[2][2];
        return result;
    }
    /// rotate vertex around A, B and C axis, (C first, then B and A)
    GLVertex rotateABC(const GLfloat a, const GLfloat b, const GLfloat c) {
        GLfloat M[3][3];
        GLfloat zC = cos(c);
        GLfloat zS = sin(c);
        GLfloat yC = cos(b);
        ...
        GLfloat xC = cos(a);
        GLfloat xS = sin(a);
        M[0][0] =  zC * yC;                 M[0][1] = -zS * yC;                 M[0][2] =  yS;
        M[1][0] =  zS * xC + zC * yS * xS;  M[1][1] =  zC * xC - zS * yS * xS;  M[1][2] = -yC * xS;
        M[2][0] =  zS * xS - zC * yS * xC;  M[2][1] =  zC * xS + zS * yS * xC;  M[2][2] =  yC * xC;
        // matrix multiply
        GLVertex result;
        result.x = x * M[0][0] + y * M[0][1] + z * M[0][2];
        result.y = x * M[1][0] + y * M[1][1] + z * M[1][2];
    ...
    /// rotate vertex around A, B and C axis, (A first, then B and C)
    GLVertex rotateCBA(const GLfloat a, const GLfloat b, const GLfloat c) {
        GLfloat M[3][3];
        GLfloat zC = cos(c);
        GLfloat zS = sin(c);
        GLfloat yC = cos(b);
        ...
        GLfloat xC = cos(a);
        GLfloat xS = sin(a);
        M[0][0] =  zC * yC;                 M[0][1] = -zS * xC + zC * yS * xS;  M[0][2] =  zS * xS + zC * yS * xC;
        M[1][0] =  zS * yC;                 M[1][1] =  zC * xC + zS * yS * xS;  M[1][2] = -zC * xS + zS * yS * xC;
        M[2][0] = -yS;                      M[2][1] =  yC * xS;                 M[2][2] =  yC * xC;
        // matrix multiply
        GLVertex result;
        result.x = x * M[0][0] + y * M[0][1] + z * M[0][2];
        result.y = x * M[1][0] + y * M[1][1] + z * M[1][2];
    ...
    /// rotate vertex by rotation matrix M
    GLVertex rotateM(const GLfloat M[3][3]) {
        // matrix multiply
        GLVertex result;
        result.x = x * M[0][0] + y * M[0][1];
        result.y = x * M[1][0] + y * M[1][1] + z * M[1][2];

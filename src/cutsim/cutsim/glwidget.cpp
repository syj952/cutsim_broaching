...
void GLWidget::drawWithNames()
{
    glPushMatrix();
#ifdef MULTI_AXIS
    glRotatef(tool.a*180.0/CUTSIM_PI, 1.0f, 0.0f, 0.0f);
    glRotatef(tool.c*180.0/CUTSIM_PI, 0.0f, 0.0f, 1.0f);
#endif
...
#endif
{
        ...
        // draw quarter torus
    {
        int numc = 5;
        int numt = 20;
        double s, t, x, y, z, twopi = 2 * CUTSIM_PI, halfdpi = CUTSIM_PI / 2 + 0.5;

...
//#define MULTI_AXIS
#define CUTSIM_PI		(3.1415926535897932)
#define CALC_TOLERANCE	(1e-6)

//added hust
#define blade_TOLERANCE	(1e-1)
#define CudaStream
...
//#define MULTI_THREAD_STL_NEIGHBOR // for STL file neighber searching // become slower if enabled both in debug and release modes, why?
...
#define PARTS_COLOR			0.5,0.5,0.5
